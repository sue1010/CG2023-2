...
//    Shader teapotVertexShader{ Shader::Type::VERTEX, AssetManager::readShader("phong_lighting_vs") };
//    Shader teapotFragmentShader{ Shader::Type::FRAGMENT, AssetManager::readShader("phong_lighting_fs") };
    ...
    Texture chessColor{ Texture::Type::ColorMap, AssetManager::readTexture("brick_color") };
    Texture chessNormal{ Texture::Type::NormalMap, AssetManager::readTexture("brick_color") };
    ...
    Object teapot{ AssetManager::readBinaryObject("boar"), island};
